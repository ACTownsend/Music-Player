  ...
  return (
    <div className='border borer-gray-300 rounded-md px-4 py-1 relative cursor-pointer hover:border-gray-400'>
        ...
        {filterData && filterMenu && (
          <div className='w-48 z-50  max-h-44 overflow-y-scroll scrollbar-thin scrollbar-track-gray-200 scrollbar-thumb-gray-400 py-2 flex flex-col rounded-md shadow-md absolute top-8 left-0 bg-white'>
            {filterData?.map(data => (
              <div key={data.name}
